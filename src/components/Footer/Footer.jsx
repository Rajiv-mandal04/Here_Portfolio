    ...
    <footer className="relative overflow-hidden text-white py-12 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      ...
      <div className="relative container mx-auto text-center z-10">
        ...
        <div className="flex justify-center gap-7 mt-9">
          {[
            { icon: <FaFacebook />, link: "https://www.facebook.com/rajiv.mandal.541036?mibextid=ZbWKwL" },
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/rajiv-kr-mandal-a063a62b0/" },
            { icon: <FaInstagram />, link: "https://www.instagram.com/rajiv.bm5/" },
          ].map((item, index) => (
            <a
              key={index}
              href={item.link}
        ...
        <p className="text-sm text-gray-500 mt-6 tracking-wide">
          © 2026 <span className="text-orange-400">Rajiv Mandal</span>. All rights reserved.
        </p>
      </div>
    </footer>
  );
